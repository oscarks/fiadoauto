...
const menuItems = [
  ...
  { titleKey: 'layout.menu.myProvider', icon: 'mdi-store', to: '/my-provider', roles: ['PROVIDER_ADMIN'] },
  { titleKey: 'layout.menu.users', icon: 'mdi-account-group', to: '/users', roles: ['PROVIDER_ADMIN'] },
  { titleKey: 'layout.menu.auditLogs', icon: 'mdi-clipboard-text-clock', to: '/audit-logs', roles: ['PROVIDER_ADMIN'] },
];
